...
def get_fer_data(data_path="D:\Pythonnnn\弱监督的农业社会化销售服务评价\降维\data_embed_npy{}_10.npy".format(i),
                 label_path="D:\Pythonnnn\弱监督的农业社会化销售服务评价\降维\label_npu{}_10.npy".format(i)):
    """
...
def plot_embedding_2D(data, label):
    ...
    plt.legend(["类别 0","类别 1","类别 2"],loc='best')

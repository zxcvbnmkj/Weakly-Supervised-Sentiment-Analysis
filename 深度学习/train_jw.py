...
def train(epoch, train_data, encoder, optimizer,criterion):
    ...
    for i_batch, (input_variable, lengths, target_variable) in enumerate(train_data):
        ...
        #正式输入模型
        outputs,jw = encoder(input_variable, lengths)
        if epoch==10:
    ...
    if epoch==10:
        ...
        np.save("D:\Pythonnnn\弱监督的农业社会化销售服务评价\降维\data_embed_npy0_10.npy", data_embed_npy0)
        np.save("D:\Pythonnnn\弱监督的农业社会化销售服务评价\降维\data_embed_npy1_10.npy", data_embed_npy1)
        np.save("D:\Pythonnnn\弱监督的农业社会化销售服务评价\降维\data_embed_npy2_10.npy", data_embed_npy2)
        np.save("D:\Pythonnnn\弱监督的农业社会化销售服务评价\降维\data_embed_npy3_10.npy", data_embed_npy3)
        np.save("D:\Pythonnnn\弱监督的农业社会化销售服务评价\降维\data_embed_npy4_10.npy", data_embed_npy4)
        np.save("D:\Pythonnnn\弱监督的农业社会化销售服务评价\降维\data_embed_npy5_10.npy", data_embed_npy5)
        np.save("D:\Pythonnnn\弱监督的农业社会化销售服务评价\降维\data_embed_npy6_10.npy", data_embed_npy6)
        np.save("D:\Pythonnnn\弱监督的农业社会化销售服务评价\降维\data_embed_npy7_10.npy", data_embed_npy7)

        np.save("D:\Pythonnnn\弱监督的农业社会化销售服务评价\降维\label_npu0_10.npy", label_npu0)
        np.save("D:\Pythonnnn\弱监督的农业社会化销售服务评价\降维\label_npu1_10.npy", label_npu1)
        np.save("D:\Pythonnnn\弱监督的农业社会化销售服务评价\降维\label_npu2_10.npy", label_npu2)
        np.save("D:\Pythonnnn\弱监督的农业社会化销售服务评价\降维\label_npu3_10.npy", label_npu3)
        np.save("D:\Pythonnnn\弱监督的农业社会化销售服务评价\降维\label_npu4_10.npy", label_npu4)
        np.save("D:\Pythonnnn\弱监督的农业社会化销售服务评价\降维\label_npu5_10.npy", label_npu5)
        np.save("D:\Pythonnnn\弱监督的农业社会化销售服务评价\降维\label_npu6_10.npy", label_npu6)
        np.save("D:\Pythonnnn\弱监督的农业社会化销售服务评价\降维\label_npu7_10.npy", label_npu7)
        print("标签存储完毕")
...
def valid(val_data, encoder,criterion):
    ...
    with torch.no_grad():
        ...
        for i_batch, (input_variable, lengths, target_variable) in enumerate(val_data):
            ...
            outputs,_ = encoder(input_variable, lengths)

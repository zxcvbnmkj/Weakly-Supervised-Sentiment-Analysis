...
# -*- coding: utf-8 -*-
import warnings
from 深度学习模型整理版.DiceLoss import MultiDSCLoss
from 深度学习模型整理版.models import OurModel
...
def main():
    #获取词频文件
    voc = Lang(r'D:\Pythonnnn\弱监督的农业社会化销售服务评价\深度学习\dl_data\1_WORDMAP.json')
    ...
    encoder = OurModel(voc.n_words, hidden_size, encoder_n_layers, dropout)
